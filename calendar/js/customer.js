var formItems = [{ name: 'titleId', display: '行程種類', options: [{ type: '記者會', id: 1 }, { type: '媒體參訪', id: 2 }, { type: '活動', id: 3 }] }, { name: 'titleData', display: '日期時間' }, { name: 'titleName', display: '行程名稱' }, {
        name: 'DDL_SDT_DEPTCD',
        display: '主辦單位',
...
function eventDialog(color, newEvt, orgEvt) {
    var paper = $('<div/>'),
        newEvt = (newEvt || newEvt === 'true') ? true : false;
...
function renderDialogGroup(value) {
    var dep, item = $('<div class="form-group form-group-lg"/>'),
        val = value;
...
function renderEditButton() {
    ...
    var ChangeDisabled = function() {
        let titleId = document.getElementById('titleId'),
            titleData = document.getElementById('titleData'),
            titleName = document.getElementById('titleName'),
            DDL_SDT_DEPTCD = document.getElementById('DDL_SDT_DEPTCD'),
            titlePlace = document.getElementById('titlePlace'),
            contact = document.getElementById('titleContact'),
            phone = document.getElementById('titlePhone');
        ...
        if (value) {
            ...
            DDL_SDT_DEPTCD.disabled = false;
            titlePlace.disabled = false;
            contact.disabled = false;
            phone.disabled = false;
        } else {
            value = true;
            titleId.disabled = true;
            titleData.disabled = true;
            titleName.disabled = true;
            DDL_SDT_DEPTCD.disabled = true;
            titlePlace.disabled = true;
